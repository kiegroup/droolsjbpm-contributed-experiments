...
public class RandomForestRegistry {
    ...
    private String selectedService = System.getProperty("org.jbpm.prediction.randomforest", SparkRandomForest.IDENTIFIER);
    ...
    public synchronized void addStrategy(SparkRandomForest predictionService) {
