...
//@mireynol - this was not present in the 5.0 code base so I moved it over from the 4.0.x one
...
public class BoostedTester extends Tester {
    ...
    public void printStats( final Stats evaluation, String executionSignature ) {
        super.printStats( evaluation, executionSignature, true ); // @mireynol - just adding the boolean to make the method signature compatible
    }
