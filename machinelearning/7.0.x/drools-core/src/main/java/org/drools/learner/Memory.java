...
public class Memory {
    ...
    public static Memory createFromWorkingMemory( WorkingMemory session, Class<?> clazz, DomainAlgo domain, DataType data ) throws FeatureNotSupported {
        ...
        mem.session = session; // @mireynol - I'm not sure why it does this
        ...
        mem.instances.put( clazz, new InstanceList( inst_schema, session ) );
         ...
         */
        Iterator<Object> it_object = (Iterator<Object>) session.iterateObjects(); // how can i get the object type nodes
